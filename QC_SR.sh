...
quast -r /shared/Project1_Resources/GROUP2_Workspace/SarojQCResults/Haloferax_volcanii_DS2_Ref/ncbi-genomes-2022-02-10/GCF_000025685.1_ASM2568v1_genomic.fna.gz --labels S1_QC,S5_QC,S6_QC,S7_QC,S8_QC --glimmer /shared/Project1_Resources/GROUP2_Workspace/lewis_unicycle_shortreads/H*/assembly*.fasta -o QCResults/ShortReadQC
